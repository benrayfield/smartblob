...
public class CollisionsChangeSpeed implements GlobalChangeSpeed{
	...
	public CollisionsChangeSpeed(float fractionOfPreventOverlap){
		...
		if(!a.isIgnorePhysics() && !b.isIgnorePhysics()){
			...
			if(ra.intersects(rb)){
				...
				if(a instanceof LayeredZigzag && b instanceof LayeredZigzag){
					rectanglesIntersect((LayeredZigzag)a, (LayeredZigzag)b, fractionOfPreventOverlap);
				}else{
	...
	public void rectanglesIntersect(LayeredZigzag a, LayeredZigzag b, float fractionOfPreventOverlap){
	...
	*/
	protected void handleIntersectsBetweenPointAndWeightedSumOfLine(
			Rect intersect, LayeredZigzag myPoints, LayeredZigzag myLines, float fractionOfPreventOverlap){
	...
	*/
	@Deprecated //use handleIntersectsBetweenPointAndWeightedSumOfLine
