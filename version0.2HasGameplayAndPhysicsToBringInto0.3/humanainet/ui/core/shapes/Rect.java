...
public class Rect{
	...
	//TODO being such a simple thing, should Rect be moved to humanaicore? Only if whole package can be, or if enough of the same package could be moved with it.
