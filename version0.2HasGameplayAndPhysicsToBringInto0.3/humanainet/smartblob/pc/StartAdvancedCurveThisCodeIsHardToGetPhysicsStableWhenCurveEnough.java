...
public class StartAdvancedCurveThisCodeIsHardToGetPhysicsStableWhenCurveEnough{
	
	public static void main(String args[]){
		JFrame window = new JFrame("Smartblob 0.1 in-progress physics without smarts so far");
		window.setJMenuBar(newMenubar());
		if(1<2) throw new RuntimeException("TODO, constructor was removed: new SmartblobsPanelAdvancedCurve()");
		//window.add(new SmartblobsPanelAdvancedCurve());
