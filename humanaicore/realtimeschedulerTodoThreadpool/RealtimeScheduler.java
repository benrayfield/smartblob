...
public class RealtimeScheduler{
	...
	private static Map<Task,TaskThread> taskToThread = new HashMap<Task,TaskThread>();
	...
	*/
		...
		*/
		...
		public void run(){
			while(true){
				...
				task.event(new TimedEvent());
				secondsSleep = task.preferredInterval();
	...
	public static void main(String args[]){
		...
		while(tasksExist){
			...
			tasksExist = tasksArray.length > 0;
			Arrays.sort(tasksArray, new Comparator<Task>(){
